  ...
  useEffect(() => {
    async function loadLookups() {
      try {
        ...
        setLookupError('Could not load agencies or recipients. Check your connection and try again.');
      } finally {
  ...
  return (
    <div className="page-stack">
      ...
      <div className="page-header">
        ...
        <p className="page-subtitle">Capture the minimum record needed to begin MBRA review workflow.</p>
      </div>
          ...
          <form className="create-form" onSubmit={handleSubmit}>
            ...
            {lookupError ? (
              ...
              <div className="form-row">
                ...
                <div className="form-group">
                  <label className="form-label" htmlFor="cf-client">Benefit Recipient {!organizationId && <span className="required-star">*</span>}</label>
            ...
            {subjectMissing && !lookupLoading && !lookupError && (
              <div className="field-hint-warn">At least one agency or benefit recipient must be selected.</div>
            )}
            ...
            <div className="form-actions">
              ...
              <button type="submit" className="btn btn-primary" disabled={submitting || lookupLoading || subjectMissing}>
                {submitting ? 'Creating...' : lookupLoading ? 'Loading...' : 'Create Review'}
              </button>
            </div>
          </form>
        </div>
